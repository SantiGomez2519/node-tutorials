...
exports.BooksModule = BooksModule = __decorate([
    (0, common_1.Module)({
        ...
        controllers: [books_controller_1.BooksController, review_controller_1.ReviewsController],
        providers: [books_service_1.BooksService, review_service_1.ReviewsService],
    })
], BooksModule);
